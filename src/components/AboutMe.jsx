...
const AboutMe = () => {
    ...
    return (
        <div
            id="about"
            className="w-full py-[50px] md:py-[100px] bg-black text-gray-300 relative overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                {/* PARAGRAPH START */}
                <Div className="text-gray-500 max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
                ...
                {/* PARAGRAPH START */}
                <Div className="text-gray-500 max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] mb-[20px] md:mb-[30px] 2xl:mb-[50px] relative">
                I have completed my Bachelor's degree in Software Engineering from Vellore Institute Of Technology, Bhopal. Throughout my academic journey, I have gained valuable knowledge and experience in areas such as software design, agile methodologies, and user experience (UX) design. To stay updated with the latest trends and technologies in the field, I actively participate in seminars and workshops, including the Fintech Club Events.

                </Div>
                {/* PARAGRAPH END */}

                {/* PARAGRAPH START */}
                <Div className="text-gray-500 max-w-[759px] 2xl:max-w-[959px] text-[16px] 2xl:text-[20px] leading-[24px] 2xl:leading-[32px] relative">
